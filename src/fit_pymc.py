...
if __name__ == "__main__":
    ...
    wav_edges = np.c_[[line_wavs - cfg.set_hwhm_kms / 3e5 * line_wavs,
                       line_wavs + cfg.set_hwhm_kms / 3e5 * line_wavs]].T
    ...
    #is_set = vel_fwhm_kms < 2*cfg.set_hwhm_kms
    ...
    #df_lines_sn = pd.read_csv(cfg.fname_lines_snr)
        ...
        for obj_id, group_obj in group_grat.groupby('PROG_ID'):
            for idx_row, row in group_obj.iterrows():
                ...
                fit_edges = exclude_fit_windows(
                    fit_range, hwhm=cfg.set_hwhm_kms, 
                ...
                for j in range(n_sets):
                    ...
                    fit_edges = exclude_fit_windows(
                        fit_range, hwhm=cfg.set_hwhm_kms, lines=line_set_wavs_j
                    )
                    fit_edges = fit_edges.flatten()[1:-1].reshape(-1, 2)
